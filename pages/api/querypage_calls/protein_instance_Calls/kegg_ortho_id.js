...
const query = `SELECT k.KEGG_ko, k.KEGG_Pathway, k.KEGG_Module, k.KEGG_rclass, pr.name AS gene_name, nl.start_min, 
nl.end_min, ena.source_ID AS scaffold, ena.sequence AS external_sequence FROM KEGG k JOIN protein pr ON 
