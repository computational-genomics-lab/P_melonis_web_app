...
const query = `SELECT p.PFAMs, pr.name AS gene_name, nl.start_min, 
nl.end_min, ena.source_ID AS scaffold, ena.sequence AS external_sequence FROM Pfam p JOIN protein pr ON 
