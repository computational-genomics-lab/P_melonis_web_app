// // pages/gene-details/[geneName].js
// import React, { useEffect, useState } from 'react';
// import { useRouter } from 'next/router';

// const GeneDetailsPage = () => {
//   const router = useRouter();
//   const { geneName, taxonID, strainNumber } = router.query; // Get parameters from URL
...
//   return (
//     <div>
//       <h1>{taxonID} {strainNumber}</h1>
//       <h2>Gene Details for {geneName}</h2>
